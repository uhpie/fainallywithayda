      ...
      {TABS.map(({ id, label, Icon }) => {
        ...
        return (
          ...
          >
            {/* Tooltip for RSVP */}
            {id === 'rsvp' && showTooltip && (
              <div className="absolute bottom-full mb-1 left-1/2 -translate-x-1/2 z-50 pointer-events-none">
                <div className="flex flex-col items-center animate-bounce drop-shadow-md">
                  <div className="bg-cream text-pink px-3 py-1.5 rounded-lg font-sans text-[10px] font-bold tracking-widest uppercase whitespace-nowrap">
                    Tekan RSVP
                  </div>
                  <div className="w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[6px] border-t-cream" />
                </div>
              </div>
            )}
